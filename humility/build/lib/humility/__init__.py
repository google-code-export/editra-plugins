###############################################################################
# Name: __init__.py                                                           #
# Purpose: Provides the Humility icon theme for Editra                        #
# Author: Cody Precord <cprecord@editra.org>                                  #
# Copyright: (c) 2007 Cody Precord <cprecord@editra.org>                      #
# Licence: wxWindows Licence                                                  #
###############################################################################
"""Humility icon theme for Editra"""
...
# Add extra art resources
ed_theme.ART[ed_glob.ID_DEL_BM] = 'bmark_del.png'

#-----------------------------------------------------------------------------#

class HumilityTheme(plugin.Plugin):
    """Represents the Humility Icon theme for Editra"""
